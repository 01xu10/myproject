...
IP_PROXY_LIST = [
    {'ip_port': '121.5.7.78:16818', 'user_passwd': 's403411124:80i9bdkq'},
]

DOWNLOADER_MIDDLEWARES = {
   'jdbookspider.middlewares.ProxyMiddleware': 542,
    'jdbookspider.middlewares.ParseStartUrlMiddleware': 300,
   'jdbookspider.middlewares.UserAgentMiddleware': 543,
}
